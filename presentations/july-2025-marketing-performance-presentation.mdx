...
<MetricGrid 
  metrics={[
    {label: "New Leads (July)", value: 16, unit: "", change: 0},
    {label: "Contracts Signed (July)", value: 3, unit: "", change: 0},
    {label: "Contract Value (July)", value: 404.56, unit: "K", change: 0},
...
<MetricGrid 
  metrics={[
    {label: "New Leads (July)", value: 16, unit: "", change: 0},
    {label: "Sold Contracts (July)", value: 2, unit: "", change: 0},
    {label: "In Progress (July)", value: 11, unit: "", change: 0},
    {label: "Conversion Rate (July)", value: 12.5, unit: "%", change: 0}
  ]}
/>
...
🎯 **Key Opportunities (Current)**: **MURRAY REMODEL** (65% confidence, $30K-$35K), **CAVAGNINI REMODEL** (55% confidence, $100K-$125K), **CATHEY REMODEL** (54% confidence, $200K-$250K)
</CalloutBox>
...
<ChartSection 
  title="Lead Source Distribution (July 2025)"
  type="pie"
  data={[
...
<MetricGrid 
  metrics={[
    {label: "Website Users (July)", value: 1983, unit: "", change: 0},
    {label: "New Users (July)", value: 96.2, unit: "%", change: 0},
    {label: "Direct Traffic (July)", value: 39.7, unit: "%", change: 0},
    {label: "Organic Search (July)", value: 32.3, unit: "%", change: 0}
  ]}
/>
...
<TextCard 
  title="Lead Attribution Challenge (July)"
  doodleIcon="interface/bulb"
  emphasis="warning"
>
**37.5%** of July leads have unknown source attribution - implementing better tracking could reveal **$150K+** in hidden pipeline value and optimize marketing spend allocation.
</TextCard>
